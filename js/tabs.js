...
let tabs = [{
        name: 'github',
        contentLink: 'https://github.com/Nzcheinenm',
        contentLinkText: '@github/Nzcheinenm',
        contentText: 'Здесь вы можете посмотреть мои проекты'
    },
    {
        name: 'email',
        contentLink: 'koliasam@yandex.ru',
        contentLinkText: 'koliasam@yandex.ru',
        contentText: 'Ваши предложения'
    },
    {
        name: 'skype',
        contentLink: '',
        contentLinkText: 'live@fizik29',
